...
impl AutoImport2{
    pub fn new(mut buf: &mut ByteBuf) -> Result<AutoImport2, LubanError> {
        let id = buf.read_int();
...
impl TestFieldAlias{
    pub fn new(mut buf: &mut ByteBuf) -> Result<TestFieldAlias, LubanError> {
        let id = buf.read_int();
        let name = buf.read_string();
...
impl TestFieldVariant{
    pub fn new(mut buf: &mut ByteBuf) -> Result<TestFieldVariant, LubanError> {
        let id = buf.read_int();
        let name = buf.read_string();
...
impl TestFieldVariant2{
    pub fn new(mut buf: &mut ByteBuf) -> Result<TestFieldVariant2, LubanError> {
        let id = buf.read_int();
        let name = buf.read_string();
...
impl TestRange{
    pub fn new(mut buf: &mut ByteBuf) -> Result<TestRange, LubanError> {
        let id = buf.read_int();
...
impl TbTestRange {
    pub fn new(mut buf: ByteBuf) -> Result<std::sync::Arc<TbTestRange>, LubanError> {
...
impl TbTestFieldAlias {
    pub fn new(mut buf: ByteBuf) -> Result<std::sync::Arc<TbTestFieldAlias>, LubanError> {
...
impl TbTestFieldVariant {
    pub fn new(mut buf: ByteBuf) -> Result<std::sync::Arc<TbTestFieldVariant>, LubanError> {
...
impl TbTestFieldVariant2 {
    pub fn new(mut buf: ByteBuf) -> Result<std::sync::Arc<TbTestFieldVariant2>, LubanError> {
...
impl TbAutoImport2 {
    pub fn new(mut buf: ByteBuf) -> Result<std::sync::Arc<TbAutoImport2>, LubanError> {
